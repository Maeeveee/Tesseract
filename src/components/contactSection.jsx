export default function ContactSection() {
    const contacts = [
        ...
        {
            name: "LinkedIn",
            url: "https://linkedin.com/in/rizalabrar",
            icon: (
                <svg className="w-7 h-7 mb-2" viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
        ...
        {
            name: "Instagram",
            url: "https://instagram.com/rizalabrar_",
            icon: (
                <svg className="w-7 h-7 mb-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        ...
        {
            name: "Spotify",
            url: "https://open.spotify.com/user/314b24gi2lyqg6ldriikfog5kc5u?si=f85c20902f5a49af",
            icon: (
                <svg
    ...
    return (
        <section className="border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div className="p-6">
                <h1 className="text-4xl text-white font-bold mb-4">Where u can find me</h1>
                <p className="text-md lg:text-xl text-gray-400 mb-8">Your direct line to His Majesty <span className="font-semibold text-gray-200">Raja React</span>.
                </p>
                    ...
                    {contacts.map((c, i) => (
                        <li key={i}>
                            <a
                                ...
                                className={`flex flex-col items-center border-2 border-dashed border-gray-700 rounded-xl p-4 bg-white/10 dark:bg-gray-800/40 text-gray-300 transition-all duration-200 hover:scale-105 ${c.hover}`}
                            >
                                {c.icon}
                                <span className="font-semibold text-lg">{c.name}</span>
                                <span className="text-xs mt-1 bg-gray-800 px-2 py-0.5 rounded text-gray-400">{c.badge}</span>
                            </a>
                        </li>
                    ))}
                </ul>
