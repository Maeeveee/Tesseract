        ...
        <section className="p-4 sm:ml-64">
            <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-4xl font-bold text-white mb-4">Note History</h2>
                    <Link to="/form" className="mb-4 text-white bg-gray-800 hover:bg-gray-700 text-md font-semibold rounded-full px-4 py-1 inline-block">New</Link>
                </div>
